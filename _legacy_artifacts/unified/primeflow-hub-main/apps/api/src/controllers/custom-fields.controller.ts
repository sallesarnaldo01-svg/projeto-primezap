...
export const customFieldsController = {
  ...
  async list(req: Request, res: Response) {
    try {
      ...
      logger.error({ error }, 'Erro ao listar campos customizados');
  ...
  async create(req: Request, res: Response) {
    try {
      ...
      logger.info({ fieldId: field.id }, 'Campo customizado criado');
      res.status(201).json(field);
    } catch (error) {
      logger.error({ error }, 'Erro ao criar campo customizado');
      throw error;
    }
  },
  ...
  async update(req: Request, res: Response) {
    try {
      ...
      logger.info({ fieldId: id }, 'Campo customizado atualizado');
      res.json(updated);
    } catch (error) {
      logger.error({ error }, 'Erro ao atualizar campo');
      throw error;
    }
  },
  ...
  async delete(req: Request, res: Response) {
    try {
      ...
      logger.info({ fieldId: id }, 'Campo customizado deletado');
      res.status(204).send();
    } catch (error) {
      logger.error({ error }, 'Erro ao deletar campo');
      throw error;
    }
  },
  ...
  async listEntities(req: Request, res: Response) {
    try {
      ...
      logger.error({ error }, 'Erro ao listar entidades');
      throw error;
    }
  }
};
