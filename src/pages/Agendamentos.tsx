...
export default function Agendamentos() {
  ...
  // Carrega eventos reais quando possível
  useMemo(() => {
    (async () => {
      try {
  ...
  const handleSendConfirmation = async (appointment: Appointment) => {
    try {
      ...
      toast.success(`Confirmação enviada para ${appointment.contact}.`);
    } catch {
              ...
              <DialogContent className="max-w-2xl">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label>Título</Label>
                    <Input placeholder="Ex: Reunião de apresentação" value={formTitle} onChange={(e) => setFormTitle(e.target.value)} />
                  </div>
                  <div className="space-y-2">
                    <Label>Contato</Label>
                  ...
                  <div className="space-y-2 col-span-2">
                    ...
                    <Input placeholder="Ex: Google Meet, Zoom, Endereço..." value={formLocation} onChange={(e) => setFormLocation(e.target.value)} />
                  </div>
                  <div className="space-y-2 col-span-2">
                    <Label>Observações</Label>
                    <Textarea placeholder="Observações sobre o agendamento..." value={formNotes} onChange={(e) => setFormNotes(e.target.value)} />
                  </div>
                </div>
                    ...
                    >
                      ...
                      <div className="text-right space-y-1">
                        ...
                        {appointment.lastReminderSent && (
                          <p className="text-xs text-muted-foreground">
                            Último lembrete às {new Date(appointment.lastReminderSent).toLocaleTimeString('pt-BR', {
                              hour: '2-digit',
                              minute: '2-digit'
                            })}
                          </p>
