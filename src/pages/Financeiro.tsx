...
export default function Financeiro() {
  ...
  const handleExportarRelatorio = async () => {
    try {
      ...
      toast({ title: 'Falha ao exportar relatório', variant: 'destructive' });
    }
  };
              ...
              <DialogContent>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input id="descricao" placeholder="Descreva os serviços..." value={novaDescricao} onChange={(e) => setNovaDescricao(e.target.value)} />
                  </div>
